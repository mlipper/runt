...
An Event is simply a container for domain data which has an :id field for
uniqueness purposes. Although, Runt uses Events by default, Schedules can 
house any hashable Object. 
