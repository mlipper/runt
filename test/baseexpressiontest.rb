...
class BaseExpressionTest < Test::Unit::TestCase
  ...
  def setup
    ...
    @pdate_1922041816 = PDate.hour(1922,4,18,16) # 4 pm, April 18th, 1922
    @pdate_1975060512 = PDate.hour(1975,6,5,12)   # 12 pm, June 5th, 1975
    @pdate_2012050803 = PDate.hour(2012,5,8,3)   # 3 am, May 8th, 2012
    @pdate_2012050815 = PDate.hour(2012,5,8,15)  # 3 pm, May 8th, 2012
